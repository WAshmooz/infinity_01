...
{
public:
    explicit IRETask(Priority priority_ = MEDIUM): ITask(priority_) {}; //gava style
...
/*
This interface encapsulate the interface of ITask -> (ADMIN Priority, nasted class ThreadPool)
*/
